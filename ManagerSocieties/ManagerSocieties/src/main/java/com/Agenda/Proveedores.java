...
public class Proveedores {
    ...
    public void editarProveedor (String ref, String nombre, String apellidos, String id, String telefono, String correo, String dir){
        this.proveedores.put(ref, new Proveedor(ref, nombre, apellidos, id, telefono, correo, dir));
    }
