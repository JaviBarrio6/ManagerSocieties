...
public class Usuarios {
    ...
    Usuario usuario01 = new Usuario(new Empleado("EMP0004","Javier", "Barrio", "53852636E", "608844077",
            "barriomartinjavier@gmail.com","Av. Guadarama 21, S.S. de los Reyes", null, "CEO", "02/01/2013", "28/19564596/31"), "1234",
            true, "profile-img.jpg");

    Usuario usuario02 = new Usuario(new Empleado("EMP0002","Paco", "López", "53852030Z", "674851283", "plopez@gmail.com",
            "Av. Guadarama 21, S.S. de los Reyes", null, "Repartidor", "01/01/2023", "28/15485396/31"), "1234",
            false, null);

    Usuario usuario03 = new Usuario(new Empleado("EMP0005","María del Mar", "Martín", "53852636E", "607849292", "superlux@superlux.com",
            "C. Enriq Prat de la Riba", null, "CEO", "01/01/1993", "28/15754596/31"
    ), "1234",
            true, "profile-img-mmar.jpg");

    public Usuarios () {
        this.usuarios.put("jbarrio", usuario01);
        this.usuarios.put("", usuario02);
        this.usuarios.put("", usuario03);
    }
    ...
    public void editarUsuario (String user, String ref, String nombre, String apellidos, String dni, String telefono, String email,
        ...
        this.usuarios.put(user, new Usuario(new Empleado(ref, nombre, apellidos, dni, telefono, email, direccion, null, puesto,
                antiguedad, ""), this.usuarios.get(user).getContrasenya(), this.usuarios.get(user).isAdmin(), imagen));
    }
