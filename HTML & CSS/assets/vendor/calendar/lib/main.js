...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'es-us';
    ...
    function buildDateEnv$1(settings) {
        var locale = buildLocale(settings.locale || 'es-us', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
    ...
    */
    ...
    var TableListItemEvent = /** @class */ (function (_super) {
        ...
        TableListItemEvent.prototype.render = function () {
            ...
            var timeText = buildSegTimeText(seg, timeFormat, context, true, props.defaultDisplayEventTime, props.defaultDisplayEventEnd);
            ...
            _this.renderTableRowAxis = function (rowHeight) {
                ...
                createElement(RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner$1, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (createElement("td", { ref: rootElRef, "aria-hidden": true, className: [
                    ...
                    createElement("div", { className: 'fc-timegrid-axis-frame fc-scrollgrid-shrink-frame' + (rowHeight == null ? ' fc-timegrid-axis-frame-liquid' : ''), style: { height: rowHeight } },
                        createElement("span", { className: "fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner", ref: innerElRef }, "Día")))); }));
            };
